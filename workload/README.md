...
You can install Kubectl and Helm using the install-local-dependencies script in [bash](../scripts/install-local-dependencies.sh) or [powershell](../scripts/install-local-dependencies.ps1)
...
This is autogenerated if you ran the /scripts/deploy-azure-workload.sh/ps1.
...
- run sh ./localdev/create-localdev.sh OR .\localdev\create-localdev.ps1 and set prompts for github token as any text and privatenetwork to false
...
- run sh ./localdev/create-localdev.sh OR .\localdev\create-localdev.ps1 and set prompts for github token as any text and privatenetwork to true
- This will take several minutes 
...
run sh ./localdev/delete-localdev.sh OR .\localdev\delete-localdev.ps1
...
If you did not deploy /infra with /scripts/deploy-azure-infra.sh/ps1 :
...
Using bash/powershell run

- az extension add --name aks-preview (for cluster autoscaler)
- az extension update --name aks-preview 
- apply the workload: sh ./scripts/deploy-azure-workload.sh OR ./scripts/deploy-azure-workload.ps1
- enter any value for GITHUBTOKEN
...
sh ./scripts/undeploy-azure-workload.sh OR .\scripts/undeploy-azure-workload.ps1
