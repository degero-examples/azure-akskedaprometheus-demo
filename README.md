...
│   ├── deploy-azure-infra.sh - deploy bicep and write resource detail outputs to /scripts/.env.azure 
...
│   ├── update-azure-workload.sh - helm upgrade on /workload/chart
│   └── .env.azure.sample - example env vars needed by deploy/undeploy script (autogenerated by deploy-azure-infra.sh)
│
